...
class Process {
	...
	public function custom_validation_cenae_1( $validation_result ) {
		$field_type_number  = 142;
		$field_cenae_number = 21;

		return $this->validate_cenae_field( $validation_result, $field_type_number, $field_cenae_number );
	}

	// Validate certain fields page 2
	public function custom_validation_cenae_2( $validation_result ) {
	...
	private function validate_cenae_field( $validation_result, $field_type_number, $field_cenae_number ): array {
